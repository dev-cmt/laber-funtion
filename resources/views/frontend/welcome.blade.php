<x-frontend-layout title="Home Page" :breadcrumbs="$breadcrumbs" :seotags="$seotags">
                ...
                <div class="block-slideshow__carousel">
                    <div class="owl-carousel owl-loaded owl-drag">
                        <div class="owl-stage-outer">
                            <div class="owl-stage"
                                style="transform: translate3d(-2700px, 0px, 0px); transition: all 0.25s ease 0s; width: 9450px;">
                                <div class="owl-item" style="width: 1350px;">
                                    <a class="block-slideshow__item" href="catalog.html">
                                        <span
                                            class="block-slideshow__item-image block-slideshow__item-image--desktop"
                                            style="background-image: url('frontend/images/cache/slide-3.2c5baab142e50b7ae694282607f878872.jpg')"></span>
                                        <span
                                            class="block-slideshow__item-image block-slideshow__item-image--mobile"
                                            style="background-image: url('frontend/images/cache/slide-3-mobile.2f114400cbd154facd84171d91d7570e2.jpg')"></span>
                                        <span class="block-slideshow__item-offer">30% OFF</span>
                                        <span class="block-slideshow__item-title">When Buying Parts<br>With
                                            Installation</span>
                                        <span class="block-slideshow__item-details">Installation of parts in the
                                            services of<br>our partners.</span>
                                        <span class="block-slideshow__item-button">Shop now</span>
                                    </a>
                                </div>
                                <div class="owl-item" style="width: 1350px;">
                                    <a class="block-slideshow__item" href="headlights-and-lighting.html">
                                        <span
                                            class="block-slideshow__item-image block-slideshow__item-image--desktop"
                                            style="background-image: url('frontend/images/cache/slide-2.2c5baab142e50b7ae694282607f878872.jpg')"></span>
                                        <span
                                            class="block-slideshow__item-image block-slideshow__item-image--mobile"
                                            style="background-image: url('frontend/images/cache/slide-2-mobile.2f114400cbd154facd84171d91d7570e2.jpg')"></span>
                                        <span class="block-slideshow__item-offer">45% OFF</span>
                                        <span class="block-slideshow__item-title">Not enough<br>spare parts?</span>
                                        <span class="block-slideshow__item-details">We have everything you need –
                                            replacement parts,<br>performance parts, accessories, oil &amp;
                                            fluids,<br>tools and much more...</span>
                                        <span class="block-slideshow__item-button">Shop now</span>
                                    </a>
                                </div>
                                <div class="owl-item" style="width: 1350px;">
                                    <a class="block-slideshow__item" href="fuel-system-and-filters.html">
                                        <span
                                            class="block-slideshow__item-image block-slideshow__item-image--desktop"
                                            style="background-image: url('frontend/images/cache/slide-1.2c5baab142e50b7ae694282607f878872.jpg')"></span>
                                        <span
                                            class="block-slideshow__item-image block-slideshow__item-image--mobile"
                                            style="background-image: url('frontend/images/cache/slide-1-mobile.2f114400cbd154facd84171d91d7570e2.jpg')"></span>
                                        <span class="block-slideshow__item-offer">25% OFF</span>
                                        <span class="block-slideshow__item-title">Big Choice Of<br>Wheel
                                            Tires</span>
                                        <span class="block-slideshow__item-details">Any size and diameter, with or
                                            without spikes,<br>summer or winter, rain or snow.</span>
                                        <span class="block-slideshow__item-button">Shop now</span>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="block-categories__list">
                        <div class="block-categories__item category-card category-card--layout--classic">
                            <div class="category-card__body">
                                <div class="category-card__content">
                                    <div class="category-card__image image image--type--category"><a
                                            href="engine-and-drivetrain.html" class="image__body"><img
                                                class="image__tag"
                                                src="frontend/images/cache/category-6-200x200.94428279bfba15e90f890abe2b5cc6022.jpg"
                                                alt="Engine & Drivetrain"></a></div>
                                    <div class="category-card__info">
                                        <div class="category-card__name"><a href="engine-and-drivetrain.html">Engine
                                                & Drivetrain</a></div>
                                        <ul class="category-card__children">

                                        </ul>
                                        <div class="category-card__actions"><a href="engine-and-drivetrain.html"
                                                class="category-card__link">Shop All</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="block-categories__item category-card category-card--layout--classic">
                            <div class="category-card__body">
                                <div class="category-card__content">
                                    <div class="category-card__image image image--type--category"><a
                                            href="tires-and-wheels.html" class="image__body"><img class="image__tag"
                                                src="frontend/images/cache/category-5-200x200.94428279bfba15e90f890abe2b5cc6022.jpg"
                                                alt="Tires & Wheels"></a></div>
                                    <div class="category-card__info">
                                        <div class="category-card__name"><a href="tires-and-wheels.html">Tires &
                                                Wheels</a></div>
                                        <ul class="category-card__children">
                                            <li><a href="brandix-brake-kit-bdx-750z370-s.html">Brandix
                                                    Brake&#8230;</a></li>
                                            <li><a href="glossy-gray-19-aluminium-wheel-ar-19.html">Glossy Gray
                                                    19"&#8230;</a></li>
                                            <li><a href="brandix-clutch-discs-z175.html">Brandix Clutch&#8230;</a>
                                            </li>
                                            <li><a href="set-of-four-19-inch-spiked-tires.html">Set of Four
                                                    19&#8230;</a></li>

                                        </ul>
                                        <div class="category-card__actions"><a href="tires-and-wheels.html"
                                                class="category-card__link">Shop All</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="block-categories__item category-card category-card--layout--classic">
                            <div class="category-card__body">
                                <div class="category-card__content">
                                    <div class="category-card__image image image--type--category"><a
                                            href="interior-accessories.html" class="image__body"><img
                                                class="image__tag"
                                                src="frontend/images/cache/category-4-200x200.94428279bfba15e90f890abe2b5cc6022.jpg"
                                                alt="Interior Accessories"></a></div>
                                    <div class="category-card__info">
                                        <div class="category-card__name"><a
                                                href="interior-accessories.html">Interior Accessories</a></div>
                                        <ul class="category-card__children">

                                        </ul>
                                        <div class="category-card__actions"><a href="interior-accessories.html"
                                                class="category-card__link">Shop All</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="block-categories__item category-card category-card--layout--classic">
                            <div class="category-card__body">
                                <div class="category-card__content">
                                    <div class="category-card__image image image--type--category"><a
                                            href="body-parts-and-mirrors.html" class="image__body"><img
                                                class="image__tag"
                                                src="frontend/images/cache/category-3-200x200.94428279bfba15e90f890abe2b5cc6022.jpg"
                                                alt="Body Parts & Mirrors"></a></div>
                                    <div class="category-card__info">
                                        <div class="category-card__name"><a href="body-parts-and-mirrors.html">Body
                                                Parts & Mirrors</a></div>
                                        <ul class="category-card__children">

                                        </ul>
                                        <div class="category-card__actions"><a href="body-parts-and-mirrors.html"
                                                class="category-card__link">Shop All</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="block-categories__item category-card category-card--layout--classic">
                            <div class="category-card__body">
                                <div class="category-card__content">
                                    <div class="category-card__image image image--type--category"><a
                                            href="fuel-system-and-filters.html" class="image__body"><img
                                                class="image__tag"
                                                src="frontend/images/cache/category-2-200x200.94428279bfba15e90f890abe2b5cc6022.jpg"
                                                alt="Fuel System & Filters"></a></div>
                                    <div class="category-card__info">
                                        <div class="category-card__name"><a href="fuel-system-and-filters.html">Fuel
                                                System & Filters</a></div>
                                        <ul class="category-card__children">
                                            <li><a href="air-filter-from-ashs-chainsaw.html">Air Filter
                                                    From&#8230;</a></li>

                                        </ul>
                                        <div class="category-card__actions"><a href="fuel-system-and-filters.html"
                                                class="category-card__link">Shop All</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="block-categories__item category-card category-card--layout--classic">
                            <div class="category-card__body">
                                <div class="category-card__content">
                                    <div class="category-card__image image image--type--category"><a
                                            href="headlights-and-lighting.html" class="image__body"><img
                                                class="image__tag"
                                                src="frontend/images/cache/category-1-200x200.94428279bfba15e90f890abe2b5cc6022.jpg"
                                                alt="Headlights & Lighting"></a></div>
                                    <div class="category-card__info">
                                        <div class="category-card__name"><a
                                                href="headlights-and-lighting.html">Headlights & Lighting</a></div>
                                        <ul class="category-card__children">
                                            <li><a href="left-headlight-of-brandix-z54.html">Left
                                                    Headlight&#8230;</a></li>
                                            <li><a href="taillights-brandix-z54.html">Taillights Wakita&#8230;</a>
                                            </li>
                                            <li><a href="40-megawatt-low-beam-lamp.html">40 Megawatt Low&#8230;</a>
                                            </li>
                                            <li><a href="gear-box.html">Gear Box</a></li>

                                        </ul>
                                        <div class="category-card__actions"><a href="headlights-and-lighting.html"
                                                class="category-card__link">Shop All</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--new">$349</div>
                                                <div class="product-card__price product-card__price--old">$415</div>
                                            </div>
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="40-megawatt-low-beam-lamp.html" class="image__body">
                                                <img class="image__tag"
                                                    src="frontend/images/cache/product-1-500x500.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                    alt="40 Megawatt Low Beam Lamp">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__meta"><span
                                                class="product-card__meta-title">SKU:</span> 345-99553-E</div>
                                        <div class="product-card__name">
                                            <div>
                                                <div class="product-card__badges">
                                                </div>
                                                <a href="40-megawatt-low-beam-lamp.html">40 Megawatt Low Beam
                                                    Lamp</a>
                                            </div>
                                        </div>
                                        <div class="product-card__rating">
                                                ...
                                                <div class="rating__body">
                                                    <div class="product__rating-stars">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="39"
                                                                        style="display: block; width: 52px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--current">$4
                                                </div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                                            ...
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="42"
                                                                        style="display: block; width: 117px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--current">$224
                                                </div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="brandix-clutch-discs-z175.html" class="image__body">
                                                <img class="image__tag"
                                                    src="frontend/images/cache/product-14-245x245.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                    alt="Brandix Clutch Disks Z175">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-card__info">
                                        ...
                                        <div class="product-card__name">
                                            <div>
                                                ...
                                                <a href="brandix-clutch-discs-z175.html">Brandix Clutch Disks
                                                    Z175</a>
                                            </div>
                                        </div>
                                        <div class="product-card__rating">
                                                ...
                                                <div class="rating__body">
                                                    <div class="product__rating-stars">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="44"
                                                                        style="display: block; width: 78px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--current">$345
                                                </div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="set-of-four-19-inch-spiked-tires.html" class="image__body">
                                                <img class="image__tag"
                                                    src="frontend/images/cache/product-14-245x245.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                    alt="Set of Four 19 Inch Spiked Tires">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-card__info">
                                        ...
                                        <div class="product-card__name">
                                            <div>
                                                ...
                                                <a href="set-of-four-19-inch-spiked-tires.html">Set of Four 19 Inch
                                                    Spiked Tires</a>
                                            </div>
                                        </div>
                                        <div class="product-card__rating">
                                                ...
                                                <div class="rating__body">
                                                    <div class="product__rating-stars">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="45"
                                                                        style="display: block; width: 117px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--current">$334
                                                </div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                            ...
                                            <div class="product-card__image">
                                                <div class="image image--type--product">
                                                    <a href="left-headlight-of-brandix-z54.html"
                                                        class="image__body">
                                                        <img class="image__tag"
                                                            src="frontend/images/cache/product-3-500x500.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                            alt="Left Headlight Of Brandix Z54">
                                            ...
                                            <div class="product-card__info">
                                                ...
                                                <div class="product-card__name">
                                                    <div>
                                                        ...
                                                        <a href="left-headlight-of-brandix-z54.html">Left Headlight
                                                            Of Brandix Z54</a>
                                                    </div>
                                                </div>
                                                <div class="product-card__rating">
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                            ...
                                            <div class="product-card__image">
                                                <div class="image image--type--product">
                                                    <a href="taillights-brandix-z54.html" class="image__body">
                                                        <img class="image__tag"
                                                            src="frontend/images/cache/product-11-245x245.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                            alt="Taillights Wakita Z54">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="product-card__info">
                                                ...
                                                <div class="product-card__name">
                                                    <div>
                                                        ...
                                                        <a href="taillights-brandix-z54.html">Taillights Wakita
                                                            Z54</a>
                                                    </div>
                                                </div>
                                                <div class="product-card__rating">
                                                                ...
                                                                <div class="rating">
                                                                    <div class="rating__body">
                                                                        <div class="rating__best">
                                                                            <div class="rating__current"
                                                                                data-id="28"
                                                                                style="display: block; width: 96.2px;">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                            ...
                                            <div class="product-card__image">
                                                <div class="image image--type--product">
                                                    <a href="air-filter-from-ashs-chainsaw.html"
                                                        class="image__body">
                                                        <img class="image__tag"
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                            ...
                                            <div class="product-card__image">
                                                <div class="image image--type--product">
                                                    <a href="brandix-brake-kit-bdx-750z370-s.html"
                                                        class="image__body">
                                                        <img class="image__tag"
                                                            src="frontend/images/cache/product-2-500x500.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                            alt="Brandix Brake Kit BDX-750Z370-S">
                                            ...
                                            <div class="product-card__info">
                                                ...
                                                <div class="product-card__name">
                                                    <div>
                                                        ...
                                                        <a href="brandix-brake-kit-bdx-750z370-s.html">Brandix Brake
                                                            Kit BDX-750Z370-S</a>
                                                    </div>
                                                </div>
                                                <div class="product-card__rating">
                                            ...
                                            <div class="product-card__info">
                                                ...
                                                <div class="product-card__name">
                                                    <div>
                                                        ...
                                                        <a href="brandix-clutch-discs-z175.html">Brandix Clutch
                                                            Disks Z175</a>
                                                    </div>
                                                </div>
                                                <div class="product-card__rating">
                                                                ...
                                                                <div class="rating">
                                                                    <div class="rating__body">
                                                                        <div class="rating__best">
                                                                            <div class="rating__current"
                                                                                data-id="44"
                                                                                style="display: block; width: 78px;">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                            ...
                                            <div class="product-card__image">
                                                <div class="image image--type--product">
                                                    <a href="set-of-four-19-inch-spiked-tires.html"
                                                        class="image__body">
                                                        <img class="image__tag"
                                                            src="frontend/images/cache/product-14-245x245.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                            alt="Set of Four 19 Inch Spiked Tires">
                                            ...
                                            <div class="product-card__info">
                                                ...
                                                <div class="product-card__name">
                                                    <div>
                                                        ...
                                                        <a href="set-of-four-19-inch-spiked-tires.html">Set of Four
                                                            19 Inch Spiked Tires</a>
                                                    </div>
                                                </div>
                                                <div class="product-card__rating">
                                                    <div class="rating product-card__rating-stars">
        ...
        <div class="block-banners block">
            <div class="container">
                <div class="block-banners__list">
                    ...
                    <a href="fuel-system-and-filters.html"
                        class="block-banners__item block-banners__item--style--one">
                        <span class="block-banners__item-image"><img
                                src="frontend/images/cache/banner1.fb4146d5d9e2a225936b610793f347872.jpg"
                                alt=""></span>
                    ...
                    <a href="body-parts-and-mirrors.html"
                        class="block-banners__item block-banners__item--style--one">
                        <span class="block-banners__item-image"><img
                                src="frontend/images/cache/banner2.fb4146d5d9e2a225936b610793f347872.jpg"
                                alt=""></span>
                        <span class="block-banners__item-image block-banners__item-image--blur"><img
                                src="frontend/images/cache/banner2.fb4146d5d9e2a225936b610793f347872.jpg"
                                alt=""></span>
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__info">
                                        <div class="product-card__meta"><span
                                                class="product-card__meta-title">SKU:</span> 521-57812-H</div>
                                        <div class="product-card__name">
                                            <div>
                                                <div class="product-card__badges">
                                                </div>
                                                <a href="taillights-brandix-z54.html">Taillights Wakita Z54</a>
                                            </div>
                                        </div>
                                        <div class="product-card__rating">
                                            <div class="rating product-card__rating-stars">
                                                <div class="rating__body">
                                                    <div class="product__rating-stars">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="28"
                                                                        style="display: block; width: 96.2px;">
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--current">$ 60
                                                </div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
                                    ...
                                    <div class="product-card__info">
                                        ...
                                        <div class="product-card__name">
                                            <div>
                                                ...
                                                <a href="air-filter-from-ashs-chainsaw.html">Air Filter From Ash's
                                                    Chainsaw</a>
                                            </div>
                                        </div>
                                        <div class="product-card__rating">
                                                            ...
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="40"
                                                                        style="display: block; width: 104px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="glossy-gray-19-aluminium-wheel-ar-19.html" class="image__body">
                                                <img class="image__tag"
                                                    src="frontend/images/cache/product-4-500x500.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                    alt="Glossy Gray 19" Aluminium Wheel AR-19">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-card__info">
                                        ...
                                        <div class="product-card__name">
                                            <div>
                                                ...
                                                <a href="glossy-gray-19-aluminium-wheel-ar-19.html">Glossy Gray 19"
                                                ...
                                                <div class="rating__body">
                                                    <div class="product__rating-stars">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="43"
                                                                        style="display: block; width: 130px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--current">$ 589
                                                </div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="gear-box.html" class="image__body">
                                                <img class="image__tag"
                                                    src="frontend/images/cache/product-9-245x245.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                    alt="Gear Box">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__meta"><span
                                                class="product-card__meta-title">SKU:</span> 396-78962-F</div>
                                        <div class="product-card__name">
                                            <div>
                                                <div class="product-card__badges">
                                                    <div class="tag-badge tag-badge--sale">sale</div>
                                                ...
                                                <div class="rating__body">
                                                    <div class="product__rating-stars">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="58"
                                                                        style="display: block; width: 0px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--new">$ 599
                                                </div>
                                                <div class="product-card__price product-card__price--old">$ 600
                                                </div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="piston-block.html" class="image__body">
                                                <img class="image__tag"
                                                    src="frontend/images/cache/product-7-245x245.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                    alt="Piston Block">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__meta"><span
                                                class="product-card__meta-title">SKU:</span> 969-54120-G</div>
                                        <div class="product-card__name">
                                            <div>
                                                <div class="product-card__badges">
                                                </div>
                                                <a href="piston-block.html">Piston Block</a>
                                            </div>
                                        </div>
                                        <div class="product-card__rating">
                                            <div class="rating product-card__rating-stars">
                                                <div class="rating__body">
                                                    <div class="product__rating-stars">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="59"
                                                                        style="display: block; width: 0px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--current">$ 1
                                                    200</div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="360-hp-disel-engine.html" class="image__body">
                                                <img class="image__tag"
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--new">$ 2 500
                                                </div>
                                                <div class="product-card__price product-card__price--old">$ 2 600
                                                </div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="clutch-disc.html" class="image__body">
                                                <img class="image__tag"
                                                    src="frontend/images/cache/product-8-245x245.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                    alt="Clutch Disc">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__meta"><span
                                                class="product-card__meta-title">SKU:</span> 897-47256-A</div>
                                        <div class="product-card__name">
                                            <div>
                                                <div class="product-card__badges">
                                                    <div class="tag-badge tag-badge--hot">hot</div>
                                                </div>
                                                <a href="clutch-disc.html">Clutch Disc</a>
                                            </div>
                                        </div>
                                        <div class="product-card__rating">
                                            <div class="rating product-card__rating-stars">
                                                <div class="rating__body">
                                                    <div class="product__rating-stars">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="61"
                                                                        style="display: block; width: 0px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--current">$ 80
                                                </div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="extremly-comfortable-seat.html" class="image__body">
                                                <img class="image__tag"
                                                    src="frontend/images/cache/product-16-245x245.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                    alt="Extremly comfortable seat">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__meta"><span
                                                class="product-card__meta-title">SKU:</span> 856-98895-O</div>
                                        <div class="product-card__name">
                                            <div>
                                                <div class="product-card__badges">
                                                    <div class="tag-badge tag-badge--sale">sale</div>
                                                </div>
                                                <a href="extremly-comfortable-seat.html">Extremly comfortable
                                                    seat</a>
                                            </div>
                                        </div>
                                        <div class="product-card__rating">
                                                ...
                                                <div class="rating__body">
                                                    <div class="product__rating-stars">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="62"
                                                                        style="display: block; width: 0px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--new">$ 300
                                                </div>
                                                <div class="product-card__price product-card__price--old">$ 350
                                                </div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="right-mirror.html" class="image__body">
                                                <img class="image__tag"
                                                    src="frontend/images/cache/product-18-245x245.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                    alt="Right Mirror">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__meta"><span
                                                class="product-card__meta-title">SKU:</span> 124-75426-N</div>
                                        <div class="product-card__name">
                                            <div>
                                                <div class="product-card__badges">
                                                    <div class="tag-badge tag-badge--sale">sale</div>
                                                ...
                                                <a href="right-mirror.html">Right Mirror</a>
                                            </div>
                                        </div>
                                        <div class="product-card__rating">
                                            <div class="rating product-card__rating-stars">
                                                <div class="rating__body">
                                                    <div class="product__rating-stars">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="63"
                                                                        style="display: block; width: 130px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--new">$ 120
                                                </div>
                                                <div class="product-card__price product-card__price--old">$ 140
                                                </div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="tiny-little-lamp.html" class="image__body">
                                                <img class="image__tag"
                                                    src="frontend/images/cache/product-15-245x245.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                    alt="Tiny Little Lamp">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__meta"><span
                                                class="product-card__meta-title">SKU:</span> 320-78525-J</div>
                                        <div class="product-card__name">
                                            <div>
                                                <div class="product-card__badges">
                                                    <div class="tag-badge tag-badge--new">new</div>
                                                ...
                                                <a href="tiny-little-lamp.html">Tiny Little Lamp</a>
                                            </div>
                                        </div>
                                        <div class="product-card__rating">
                                            <div class="rating product-card__rating-stars">
                                                <div class="rating__body">
                                                    <div class="product__rating-stars">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="64"
                                                                        style="display: block; width: 0px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--current">$ 40
                                                </div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="left-front-door-handle.html" class="image__body">
                                                <img class="image__tag"
                                                    src="frontend/images/cache/product-19-245x245.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                    alt="Left Front Door Handle">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__meta"><span
                                                class="product-card__meta-title">SKU:</span> 542-78012-U</div>
                                        <div class="product-card__name">
                                            <div>
                                                <div class="product-card__badges">
                                                    <div class="tag-badge tag-badge--sale">sale</div>
                                                </div>
                                                <a href="left-front-door-handle.html">Left Front Door Handle</a>
                                            </div>
                                        </div>
                                        <div class="product-card__rating">
                                            <div class="rating product-card__rating-stars">
                                                <div class="rating__body">
                                                    <div class="product__rating-stars">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="65"
                                                                        style="display: block; width: 0px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--new">$ 60</div>
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="syntetic-oil.html" class="image__body">
                                                <img class="image__tag"
                                                    src="frontend/images/cache/product-6-245x245.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                    alt="Syntetic Oil">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__meta"><span
                                                class="product-card__meta-title">SKU:</span> 525-57812-H</div>
                                        <div class="product-card__name">
                                            <div>
                                                <div class="product-card__badges">
                                                    <div class="tag-badge tag-badge--hot">hot</div>
                                                </div>
                                                <a href="syntetic-oil.html">Syntetic Oil</a>
                                            </div>
                                        </div>
                                        <div class="product-card__rating">
                                            <div class="rating product-card__rating-stars">
                                                <div class="rating__body">
                                                    <div class="product__rating-stars">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="66"
                                                                        style="display: block; width: 0px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--current">$ 15
                                                </div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="exausted-pipe.html" class="image__body">
                                                <img class="image__tag"
                                                    src="frontend/images/cache/product-5-245x245.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                    alt="Exausted Pipe">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__meta"><span
                                                class="product-card__meta-title">SKU:</span> 556-21453-C</div>
                                        <div class="product-card__name">
                                            <div>
                                                <div class="product-card__badges">
                                                    <div class="tag-badge tag-badge--new">new</div>
                                                </div>
                                                <a href="exausted-pipe.html">Exausted Pipe</a>
                                            </div>
                                        </div>
                                        <div class="product-card__rating">
                                            <div class="rating product-card__rating-stars">
                                                <div class="rating__body">
                                                    <div class="product__rating-stars">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="67"
                                                                        style="display: block; width: 0px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--current">$ 200
                                                </div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="rear-stand.html" class="image__body">
                                                <img class="image__tag"
                                                    src="frontend/images/cache/product-20-245x245.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                    alt="Rear Stand">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__meta"><span
                                                class="product-card__meta-title">SKU:</span> 453-98769-K</div>
                                        <div class="product-card__name">
                                            <div>
                                                <div class="product-card__badges">
                                                    <div class="tag-badge tag-badge--sale">sale</div>
                                                </div>
                                                <a href="rear-stand.html">Rear Stand</a>
                                            </div>
                                        </div>
                                        <div class="product-card__rating">
                                            <div class="rating product-card__rating-stars">
                                                <div class="rating__body">
                                                    <div class="product__rating-stars">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                                                <div class="rating__best">
                                                                    <div class="rating__current" data-id="68"
                                                                        style="display: block; width: 0px;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <form method="post" class="ms2_form">
                                        ...
                                        <div class="product-card__footer">
                                            <div class="product-card__prices">
                                                <div class="product-card__price product-card__price--new">$ 70</div>
                                                <div class="product-card__price product-card__price--old">$ 80</div>
                                            </div>
                                            <button class="product-card__addtocart-icon" type="submit"
                                                aria-label="Add to cart" name="ms2_action" value="cart/add">
                                                <svg width="20" height="20">
                    ...
                    <div class="owl-carousel">
                            ...
                            <div class="post-card post-card--layout--grid-sm">
                                <div class="post-card__image">
                                    <a href="philosophy-that-addresses-topics-such-as-goodness.html">
                                        <img src="frontend/images/cache/post-1-730x485.e6cbbfd3942a9720dc3579bc964b94662.jpg"
                                            alt="">
                                    </a>
                                </div>
                                <div class="post-card__content">
                                    <div class="post-card__title">
                                        <h2><a href="philosophy-that-addresses-topics-such-as-goodness.html">Philosophy
                                                That Addresses Topics Such As Goodness</a></h2>
                                    </div>
                                    <div class="post-card__date">
                                        By <a>Silent Mashiko</a> on November 04, 2020
                                    </div>
                            ...
                            <div class="post-card post-card--layout--grid-sm">
                                <div class="post-card__image">
                                    <a href="engineers-use-many-methods-to-minimize-logic-functions.html">
                                        <img src="frontend/images/cache/post-2-730x485.e6cbbfd3942a9720dc3579bc964b94662.jpg"
                                            alt="">
                                    </a>
                                </div>
                                <div class="post-card__content">
                                    <div class="post-card__title">
                                        <h2><a href="engineers-use-many-methods-to-minimize-logic-functions.html">Engineers
                                                Use Many Methods To Minimize Logic Functions</a></h2>
                                    </div>
                                    <div class="post-card__date">
                                        By <a>admin</a> on November 16, 2020
                                    </div>
                                    <div class="post-card__excerpt">
                                        <div class="typography">
                        ...
                        <div class="posts-list__item">
                            <div class="post-card post-card--layout--grid-sm">
                                <div class="post-card__image">
                                    <a
                                        href="an-advantage-of-digital-circuits-when-compared-to-analog-circuits.html">
                                        <img src="frontend/images/cache/post-8-730x485.e6cbbfd3942a9720dc3579bc964b94662.jpg"
                                            alt="">
                                    </a>
                                </div>
                                <div class="post-card__content">
                                    <div class="post-card__title">
                                        <h2><a
                                                href="an-advantage-of-digital-circuits-when-compared-to-analog-circuits.html">An
                                                Advantage Of Digital Circuits When Compared To Analog Circuits</a>
                                        </h2>
                                    </div>
                                    <div class="post-card__date">
                                        By <a>admin</a> on November 16, 2020
                        ...
                        <div class="posts-list__item">
                            <div class="post-card post-card--layout--grid-sm">
                                <div class="post-card__image">
                                    <a
                                        href="many-inquiries-outside-of-academia-are-philosophical-in-the-broad-sense.html">
                                        <img src="frontend/images/cache/post-7-730x485.e6cbbfd3942a9720dc3579bc964b94662.jpg"
                                            alt="">
                                    </a>
                                </div>
                                <div class="post-card__content">
                                    <div class="post-card__title">
                                        <h2><a
                                                href="many-inquiries-outside-of-academia-are-philosophical-in-the-broad-sense.html">Many
                                                Inquiries Outside Of Academia Are Philosophical In The Broad
                                                Sense</a></h2>
                                    </div>
                                    <div class="post-card__date">
                                        By <a>admin</a> on November 16, 2020
                            ...
                            <div class="post-card post-card--layout--grid-sm">
                                <div class="post-card__image">
                                    <a href="logic-is-the-study-of-reasoning-and-argument-part-1.html">
                                        <img src="frontend/images/cache/post-6-730x485.e6cbbfd3942a9720dc3579bc964b94662.jpg"
                                            alt="">
                                    </a>
                                </div>
                                <div class="post-card__content">
                                    <div class="post-card__title">
                                        <h2><a href="logic-is-the-study-of-reasoning-and-argument-part-1.html">Logic
                                                Is The Study Of Reasoning And Argument Part 1</a></h2>
                                    </div>
                                    <div class="post-card__date">
                                        By <a>admin</a> on November 16, 2020
                                    </div>
                            ...
                            <div class="post-card post-card--layout--grid-sm">
                                <div class="post-card__image">
                                    <a href="germany-was-the-first-country-to-professionalize-philosophy.html">
                                        <img src="frontend/images/cache/post-5-730x485.e6cbbfd3942a9720dc3579bc964b94662.jpg"
                                            alt="">
                                    </a>
                                </div>
                                <div class="post-card__content">
                                    <div class="post-card__title">
                                        <h2><a
                                                href="germany-was-the-first-country-to-professionalize-philosophy.html">Germany
                                                Was The First Country To Professionalize Philosophy</a></h2>
                                    </div>
                                    <div class="post-card__date">
                                        By <a>admin</a> on November 16, 2020
                                    </div>
                        ...
                        <div class="posts-list__item">
                            <div class="post-card post-card--layout--grid-sm">
                                <div class="post-card__image">
                                    <a
                                        href="a-variety-of-other-academic-and-non-academic-approaches-have-been-explored.html">
                                        <img src="frontend/images/cache/post-4-730x485.e6cbbfd3942a9720dc3579bc964b94662.jpg"
                                            alt="">
                                    </a>
                                </div>
                                <div class="post-card__content">
                                    <div class="post-card__title">
                                        <h2><a
                                                href="a-variety-of-other-academic-and-non-academic-approaches-have-been-explored.html">A
                                                Variety Of Other Academic And Non-Academic Approaches Have Been
                                                Explored</a></h2>
                                    </div>
                                    <div class="post-card__date">
                                        By <a>Nancy Elizabeth</a> on September 10, 2020
                                    </div>
                                    <div class="post-card__excerpt">
                                        <div class="typography">
                            ...
                            <div class="post-card post-card--layout--grid-sm">
                                <div class="post-card__image">
                                    <a href="some-philosophers-specialize-in-one-or-more-historical-periods.html">
                                        <img src="frontend/images/cache/post-3-730x485.e6cbbfd3942a9720dc3579bc964b94662.jpg"
                                            alt="">
                                    </a>
                                </div>
                                <div class="post-card__content">
                                    <div class="post-card__title">
                                        <h2><a
                                                href="some-philosophers-specialize-in-one-or-more-historical-periods.html">Some
                                                Philosophers Specialize In One Or More Historical Periods</a></h2>
                                    </div>
                                    <div class="post-card__date">
                                        By <a>admin</a> on November 16, 2020
                                    </div>
    ...
    l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                        ...
                                        <div class="product-card__image">
                                            <div class="image image--type--product">
                                                <a href="glossy-gray-19-aluminium-wheel-ar-19.html"
                                                    class="image__body">
                                                    <img class="image__tag"
                                                        src="frontend/images/cache/product-4-500x500.d9d987356f81ac80dd5e997b2f64b4652.jpg"
                                                        alt="Glossy Gray 19" Aluminium Wheel AR-19">
                                        ...
                                        <div class="product-card__info">
                                            ...
                                            <div class="product-card__name">
                                                <div>
                                                    ...
                                                    <a href="glossy-gray-19-aluminium-wheel-ar-19.html">Glossy Gray
                                                        19" Aluminium Wheel AR-19</a>
                                                </div>
                                            </div>
                                            <div class="product-card__rating">
                                                <div class="rating product-card__rating-stars">
                ...
                <ul class="block-brands__list">
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-1.99663875bbf13133fa6904fe1114f84f2.png" alt="">
                            <span class="block-brands__item-name">Aimparts</span>
                        </a>
                    </li>
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-2.99663875bbf13133fa6904fe1114f84f2.png" alt="">
                            <span class="block-brands__item-name">Windengine</span>
                        </a>
                    </li>
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-3.99663875bbf13133fa6904fe1114f84f2.png" alt="">
                            <span class="block-brands__item-name">Turboelectric</span>
                        </a>
                    </li>
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-4.99663875bbf13133fa6904fe1114f84f2.png" alt="">
                            <span class="block-brands__item-name">Startone</span>
                        </a>
                    </li>
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-5.99663875bbf13133fa6904fe1114f84f2.png" alt="">
                            <span class="block-brands__item-name">Brandix</span>
                        </a>
                    </li>
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-6.99663875bbf13133fa6904fe1114f84f2.png" alt="">
                            <span class="block-brands__item-name">ABS-Brand</span>
                        </a>
                    </li>
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-7.99663875bbf13133fa6904fe1114f84f2.png" alt="">
                            <span class="block-brands__item-name">Greatcircle</span>
                        </a>
                    </li>
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-8.99663875bbf13133fa6904fe1114f84f2.png" alt="">
                            <span class="block-brands__item-name">Justromb</span>
                        </a>
                    </li>
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-9.99663875bbf13133fa6904fe1114f84f2.png" alt="">
                            <span class="block-brands__item-name">Fastwheels</span>
                        </a>
                    </li>
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-10.99663875bbf13133fa6904fe1114f84f2.png" alt="">
                            <span class="block-brands__item-name">Stroyka-X</span>
                        </a>
                    </li>
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-11.99663875bbf13133fa6904fe1114f84f2.png" alt="">
                            <span class="block-brands__item-name">Mission-51</span>
                        </a>
                    </li>
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-12.99663875bbf13133fa6904fe1114f84f2.png" alt="">
                            <span class="block-brands__item-name">Fuelcorp</span>
                        </a>
                    </li>
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-13.99663875bbf13133fa6904fe1114f84f2.png" alt="">
                            <span class="block-brands__item-name">Redgate</span>
                        </a>
                    </li>
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-14.99663875bbf13133fa6904fe1114f84f2.png" alt="">
                            <span class="block-brands__item-name">Blocks</span>
                        </a>
                    </li>
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-15.99663875bbf13133fa6904fe1114f84f2.png" alt="">
                            <span class="block-brands__item-name">Blackbox</span>
                        </a>
                    </li>
                    <li class="block-brands__item">
                        <a href="#" class="block-brands__item-link">
                            <img src="frontend/images/cache/brand-16.99663875bbf13133fa6904fe1114f84f2.png" alt="">
